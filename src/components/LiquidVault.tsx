...
export const LiquidVault: React.FC<LiquidVaultProps> = ({
  files,
  onUploadFile,
  onDeleteFile,
  onToggleFavorite,
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
          <div className="space-y-1">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-xl font-bold text-gray-900 dark:text-slate-100">Liquid Vault • Storage Drive</h1>
            </div>
            <p className="text-xs text-gray-500 dark:text-slate-400">
              Integrated E2EE cloud file storage for all liquidchat users. Store, sync, and share files securely.
            </p>
          </div>
              ...
              {chats.map((chat) => (
                ...
                >
                  <div className="flex items-center space-x-3">
                    <img src={chat.avatar} alt={chat.name} className="w-8 h-8 rounded-xl object-cover" />
